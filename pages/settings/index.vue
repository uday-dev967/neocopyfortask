    ...
    <section style="background:white">
        ...
        <div class="setting-head">
            <div class="setting-left">
                <h2>{{ $t("myAccounts.title") }}</h2>
                <div class="nav-tabs">
                    <nuxt-link :to="localePath(parentRoute + '/plans_new')">{{ $t("buttonText.plans") }}</nuxt-link>
                    <nuxt-link  :to="localePath(parentRoute + '/plans')">{{ $t("buttonText.billing") }}</nuxt-link>
                    <nuxt-link :to="localePath(parentRoute + '/profile')">{{ $t("buttonText.profile") }}</nuxt-link>
            ...
            <div class="setting-right">
                <div class="plans-text" v-if="$route.params.type=='plans_new'">
                    <div v-html="$t('myAccounts.titlePlansTag[0]')">
                    </div>
                    <div>
                        {{ $t("myAccounts.titlePlansTag[1]") }}
                    </div>
                </div>
                <button v-if="$route.params.type=='profile'" v-on:click="update()">{{ $t("buttonText.saveChanges") }}</button>
            </div>
        </div>
