  ...
  <section class="dashboard" v-if="usersProjectsWithPagination" @scroll="onProductsScroll($event)">
    ...
    <div class="video-tutorial">
      <div class="explore-container">
        <p class="explore-head-text">Video Tutorials</p>
        ...
        <div class="cards-container" id="cards-container">
          <div class="shadow-container" v-for="video in videosData">
            <div class="card" @click="showVideo=!showVideo;  videoPlayed(video.videoLink)">
      ...
      <div class="free-demo-popup-container" v-if="getFreeDemoShow_Desk" @click="outsideClick()">
        <div class="free-demo-popup" @click.stop>
          <svg
            ...
            @click="getFreeDemoShow_Desk =false"
            width="27"
            height="27"
            viewBox="0 0 27 27"
            fill="none"
    ...
    <div class="assistance" v-if="user && user.accountInfo.accountCategory !== 'ADMIN' && users">
      ...
      <div class="bc-grid" :class="{'search-grid': searchKey}">
        <!-- <div class="breadCrumbs">
          ...
          <p @click="prepareBreadCrumbs(bread,_index)" v-for="(bread,_index) in breadcrumbs">
            <span>&nbsp;/</span>
            {{bread.name}}
          </p>
        </div> -->
        <!-- <div class="dashboard-search">
            <input type="text" v-model="searchKey" name="search" id="searchName" autocomplete="off" placeholder="Search">
      ...
      <div class="filter-tabs" v-if="searchKey">
        <!-- <p :class="{'active':filterTabSelected === 'project'}" @click="filterTabSelected = 'project'">Projects <span v-if="!filterLoading">{{searchFilterResults.projectCount}}</span></p>
        <p :class="{'active':filterTabSelected === 'folder'}" @click="filterTabSelected='folder'">Folders<span v-if="!filterLoading">{{searchFilterResults.folderCount}}</span></p> -->
      </div>
      <div v-if="!searchKey">
      ...
      <!-- <div v-if="searchKey && !filterLoading">
        ...
        <div class="no-data" v-if="!filterLoading">
          <p v-if="filterTabSelected === 'project' && searchFilterResults && searchFilterResults.projects && searchFilterResults.projects.length <= 0">NO PROJECTS DATA</p>
          <p v-if="filterTabSelected === 'folder' && searchFilterResults && searchFilterResults.folders && searchFilterResults.folders.length <= 0">NO FOLDERS DATA</p>
        </div>
      </div> -->
      <!-- filterLoading -->
      ...
      <div class="popup-container" @click.stop>
        ...
        <div class="popup-details">
          ...
          <div class="invite-button-container">
            ...
            <button @click="addProject()" :disabled="!projectName" class="update-address">Start Now</button>
          </div>
        </div>
      </div>
    </div>
    <div class="popup-div" :class="showProject?'showPopUp':''" @click="closePopup">
      <div class="popup-container" @click.stop>
        ...
        <div class="popup-details">
          ...
          <div class="invite-button-container">
            <button @click="cancelContainer('clone')" class="cancel-button">Cancel</button>
            <button
              @click="copyProject()"
      ...
      <div class="popup-container" @click.stop>
        ...
        <div class="popup-details">
          <div class="invite-input">
            <h4
              style="color: #807f7f;"
            >Once deleted, you won't be able to access the project and its renders</h4>
          </div>
          <div class="invite-button-container">
            <button @click="closePopup" class="cancel-button">Cancel</button>
            <button @click="onClickDelete()" class="update-address white">Confirm</button>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="popup-div" :class="showMove?'showPopUp':''" @click="closePopup">
      <div class="popup-container" @click.stop>
        ...
        <div class="invite-button-container">
          <button @click="closePopup()" class="cancel-button">Cancel</button>
          <button @click="onClickMove(moveProjectId)" class="update-address white">Move</button>
        </div>
      </div>
    </div>
    ...
    >
      <div class="popup-container welcome-popup" @click.stop>
        ...
        <div class="popup-head">
          ...
          <p class="wel-pop-title">Congratulations! Welcome to the Foyr Family!</p>
          <p class="wel-pop-sub-title">Create beautiful designs and stunning 3D renders within minutes!</p>
          ...
          <div class="wel-cards-container">
            <div class="wel-card-item">
              ...
              <p>Create a sample room in 2D</p>
              <p>Step 1</p>
            </div>
              <div class="wel-card-item">
              ...
              <p>Customise your design in 3D</p>
              <p>Step 2</p>
            </div>
            <div class="wel-card-item">
              <img src="~assets/images/wel-card-img.png" alt="" srcset="">
              <p>Take a realistic Render</p>
              <p>Step 3</p>
            </div>
            <!-- First Card----------- -->
            <!-- <div class="wel-card">
          ...
          <button @click="onClickWelcome('reduce_designtime')">Start Designing Now</button>
        </div>
        <!-- <div class="popup-details">
        </div>-->
      </div>
    ...
    <div v-if="showRedirect || dashMsg" class="show-redirect">
      <div>
        <h2>Foyr Neo</h2>
        <p v-if="!dashMsg">
          To be able to create or edit stunning designs,
          <span>switch to a computer with Chrome.</span>
        </p>
        <p v-else>
          This is view-only version, to explore the full power of Neo
          <span>login using a computer with chrome</span>
        </p>
      </div>
      <div>
      ...
      <div>
        <p v-if="!dashMsg">Login to your computer to start designing now</p>
        <p v-else>Explore the full power on Neo on your computer</p>
        <button @click="showRedirect = false; dashMsg = false; changeLocalStore()">OK</button>
      </div>
    </div>
    <thankyouComponent/>
  </section>
