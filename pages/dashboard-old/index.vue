<template>
  <section class="dashboard" v-if="usersProjectsWithPagination" @scroll="onProductsScroll($event)">
    <demoTourTypeForm/>
    <div v-if="bannerToShow === bannerConstants.video" class="video-tutorial" :class="{ 'hide-demo': $i18n.locale !== 'en' }">
      <div class="explore-container">
        ...
        <div class="arrow-left" @click="scroll('right')">
          ...
          >
            <path
              d="M11 1L0.999999 10.7297L11 21"
              stroke="#D48E8E"
        ...
        <div class="arrow-right" @click="scroll('left')">
          ...
          >
            <path
              d="M0.933594 21L10.9336 11.2703L0.933594 1"
              stroke="#D48E8E"
              stroke-miterlimit="10"
              stroke-linecap="round"
              stroke-linejoin="round"
        ...
        <div class="cards-container" id="cards-container">
          ...
          <!-- <div class="shadow-container">
            <div class="card" @click="showVideo=!showVideo; videoUrl='login'; videoPlayed()">
          ...
          <div class="shadow-container">
            <div class="card" @click="showVideo=!showVideo; videoUrl='floorplan'; videoPlayed()">
          ...
          <div class="shadow-container">
            <div class="card" @click="showVideo=!showVideo; videoUrl ='render'; videoPlayed()">
          ...
          <div class="shadow-container">
            <div class="card" @click="showVideo=!showVideo; videoUrl ='button'; videoPlayed()">
            <img src="~assets/images/button.jpg" alt="" class="main-image">
            <div class="card-text">
              <img src="~assets/images/play.svg" alt="">
              <p>Overview of Menus, actions and buttons</p>
            </div>
          </div>
          </div>
          <div class="shadow-container">
            <div class="card" @click="showVideo=!showVideo; videoUrl ='furniture'; videoPlayed()">
              <img src="~assets/images/furniture.jpg" alt="" class="main-image">
              <div class="card-text">
                <img src="~assets/images/play.svg" alt="">
                <p>How to use furniture</p>
              </div>
            </div>
          </div>
          <div class="shadow-container">
            <div class="card" @click="showVideo=!showVideo; videoUrl ='lights'; videoPlayed()">
              <img src="~assets/images/lights.jpg" alt="" class="main-image">
              <div class="card-text">
                <img src="~assets/images/play.svg" alt="">
                <p>How to create ceilings</p>
              </div>
            </div>
          </div>
          <div class="shadow-container">
            <div class="card" @click="showVideo=!showVideo; videoUrl ='autoGroup'; videoPlayed()">
              <img src="~assets/images/autoGroup.jpg" alt="" class="main-image">
              <div class="card-text">
                <img src="~assets/images/play.svg" alt="">
                <p>Autogroup products using Docking</p>
              </div>
            </div>
          </div>
          <div class="shadow-container">
            <div class="card" @click="showVideo=!showVideo; videoUrl ='sunPosition'; videoPlayed()">
              <img src="~assets/images/sunPosition.jpg" alt="" class="main-image">
              <div class="card-text">
                <img src="~assets/images/play.svg" alt="">
                <p>Sun Position</p>
              </div>
          ...
          <div class="shadow-container">
            <div class="card" @click="showVideo=!showVideo; videoUrl ='sunPosition'; videoPlayed()">
              ...
              <div class="card-text">
                <img src="~assets/images/play.svg" alt="">
                <p>Camera angle set</p>
              </div>
            </div>
          </div>-->
        </div>
      </div>
      <!-- <div class="left-side-image" v-if="videosData">
        <img class="freeDemoImg" src="~assets/images/freeDemoGirl.svg" alt />

        <p class="get-free-demo-desk-btn" @click="getFreeDemoShow_Desk = true">
          Get a
          <span>FREE Demo</span> now
        </p>
      </div>-->
      <div v-if="$i18n.locale == 'en'" class="free-demo-section">
      ...
      <div class="explore-container">
        ...
        <div v-if="hasContainerScrolled" class="arrow-left" @click="scroll('right')">
          <svg width="10" height="17" viewBox="0 0 10 17" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path fill-rule="evenodd" clip-rule="evenodd" d="M0.565986 16.3763C0.111067 15.9324 0.111067 15.2127 0.565986 14.7688L6.73164 8.75267L0.565986 2.73654C0.111067 2.29265 0.111067 1.57297 0.565986 1.12908C1.0209 0.685198 1.75848 0.685198 2.21339 1.12908L9.20276 7.94894C9.65768 8.39283 9.65768 9.11251 9.20276 9.5564L2.21339 16.3763C1.75848 16.8201 1.0209 16.8201 0.565986 16.3763Z" fill="black"/>
          </svg>
        </div>
        <div class="arrow-right" @click="scroll('left')">
          <svg width="10" height="17" viewBox="0 0 10 17" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <banner v-if="bannerToShow === bannerConstants.designForYou" class="request-floor-plan" :imageUrl="require('../../assets/images/dashboard/render-design-banner.png')">
      <template slot='heading'>
        <div class="heading">
          {{ $t("dashboard.getDesignDoneBannerText[0]") }}&nbsp;<div class="highlight">{{ $t("dashboard.getDesignDoneBannerText[1]") }}</div>&nbsp;{{ $t("dashboard.getDesignDoneBannerText[2]") }}
        </div>
      </template>
      <template slot='subheading'>
        <div class="subheading full-width">
          {{ $t("dashboard.getDesignDoneBannerText[3]") }} <b>{{ $t("dashboard.getDesignDoneBannerText[4]") }}</b>
        </div>
      </template>
      <template slot='bannerAction'>
        <div class="banner-action banner-action-wrapper">
          <button 
            @click="sendEventToSegment('DFU Button Click')"
          >{{ $t("dashboard.getDesignDoneBannerText[5]") }}</button>
        </div>
      </template>
    </banner>
    <!-- Foyr Moodboard -->
    <banner v-if="bannerToShow === bannerConstants.moodboard" class="moodboard-banner" :imageUrl="require('../../assets/images/dashboard/foyr-moodboard-banner.png')">
      <template slot='heading'>
        <div class="heading">
      ...
      <template slot='bannerAction'>
        <div class="banner-action banner-action-wrapper">
          <button v-if="!(isUserOnMoodBoardFreeTrial || isUserOnMoodBoardPaidPlan) && !doesUserHaveActiveMoodboardSubscription" @click="handleTryMoodboardButtonClick">{{ $t("buttonText.tryMoodboardFree") }}</button>
          <button v-else @click="setSwitchToMoodboardAndRedirectToDashboard(true)">{{ $t("buttonText.switchToMoodboard") }}</button>
        </div>
      </template>
    </banner>

    <!-- <div v-else class="support-container">
      <div class="cnt-img">
      ...
      <div class="cnt-event">
        <p>Talk to our specialist</p>
      </div>
    </div>-->
    <div class="assistance" :class="{'no-community-content': !showCommunityBanner}" v-if="user && user.accountInfo.accountCategory !== 'ADMIN' && users">
      <div class="flex" style="justify-content: space-between; position:relative">
        ...
        <div class v-if="user && user.accountInfo.accountCategory == 'ADMIN' && users">
          ...
          <ul class="searchedUser" v-if="searchUser && !searched">
            ...
            <li></li>
            <li
              v-for="(item, index) in filterByText(searchUser)"
      ...
      <div class="bc-grid" :class="{'search-grid': searchKey}">
        <div class="breadCrumbs">
          <h2
            @click="rootFolders=foldersTree; breadcrumbs=[]"
            v-if="(foldersTree && foldersTree.folders && foldersTree.folders.length > 0 && !searchKey)"
          >
            {{ $t("buttonText.myFolders") }}
            <!-- <span v-if="breadcrumbs && breadcrumbs.length <=0">&nbsp;/</span> -->
          </h2>
        ...
        <div class="dashboard-search">
            <input type="text" v-model="searchKey" name="search" id="searchName" autocomplete="off" :placeholder="$t('placeholders.search')">
            <span class="search-icon">
              <svg width="15" height="15" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
              <circle cx="5.14286" cy="5.16629" r="4.64286" stroke="#292929"/>
              <path d="M8.57153 8.59488L12.0001 12.0235" stroke="#292929" stroke-linecap="round" stroke-linejoin="round"/>
              </svg>
            </span>
        </div>
        <div
      ...
      <div class="filter-tabs" v-if="searchKey">
        <p :class="{'active':filterTabSelected === 'project'}" @click="filterTabSelected = 'project'">{{ $t("buttonText.projects") }} <span v-if="!filterLoading">{{searchFilterResults.projectCount}}</span></p>
        <p :class="{'active':filterTabSelected === 'folder'}" @click="filterTabSelected='folder'">{{ $t("buttonText.folders") }}<span v-if="!filterLoading">{{searchFilterResults.folderCount}}</span></p>
      </div>
      <div v-if="!searchKey">
      ...
      <div v-if="searchKey && !filterLoading">
        <!-- <p v-if="filterTabSelected === 'folder'">Folders</p> -->
        <foldersView v-if="filterTabSelected === 'folder'" :folders-array="searchFilterResults" :move="false"></foldersView>
        <projects v-if="filterTabSelected === 'project'" :folders-array="searchFilterResults" :breadcrumbs ="breadcrumbs" :searchKey="searchKey"></projects>
        <div class="no-data" v-if="!filterLoading">
          <p v-if="filterTabSelected === 'project' && searchFilterResults && searchFilterResults.projects && filterBetaProjects(searchFilterResults.projects).length <= 0">{{ $t("dashboard.noProjectsData") }}</p>
          <p v-if="filterTabSelected === 'folder' && searchFilterResults && searchFilterResults.folders && filterBetaProjects(searchFilterResults.folders).length <= 0">{{ $t("dashboard.noFoldersData") }}</p>
        </div>
      </div>
      <!-- filterLoading -->
      ...
      <!-- <breadCrumbs :breadCrum="{name}"></breadCrumbs> -->
    </div>
    ...
    <div class="assistance" v-if="user && user.accountInfo.accountCategory == 'ADMIN' && users">
      ...
      <div class="cards">
        <div
          v-if="userSys.device.type == 'Desktop'"
          class="card add-card"
        ...
        <div
          class="card"
          v-for="beg in usersProjectsWithPagination"
          :key="beg._id"
            ...
            <div class="card-text-head">
              ...
              <div>
                <img
                  ...
                  alt
                  @click="showProject=!showProject; copyProjectId=beg._id ;"
                />
              </div>
            </div>
  ...
  <!-- design challenge banner -->
    <banner v-if="false" class="design-challenge-banner" :imageUrl="require('../../assets/images/dashboard/third-banner-image.png')">
      <template slot='heading'>
      ...
      <template slot='subheading'>
        <div class="subheading full-width default-list">
          <ul>
            ...
            <li>{{$t("dashboard.challengeBannerListPoints[1]")}} <a @click="handleBannerCTAClick(designChallengeURL, 'design_challenge_link_cta')">{{$t("dashboard.challengeBannerListPoints[2]")}}</a></li>
            <li>{{$t("dashboard.challengeBannerListPoints[3]")}}<b>$500!</b> </li>
          </ul>
        </div>
      </template>
      <template slot='bannerAction'>
        <div class="banner-action banner-action-wrapper" @click="handleBannerCTAClick(designChallengeURL, 'design_challenge_viewdesigns_cta')">
          ...
          <div class="image-container">
            <svg width="18" height="19" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <path d="M9.16669 5.30969L9.16669 13.3097" stroke="#FBF3F1" stroke-linecap="round" stroke-linejoin="round"/>
              <path d="M12.6667 9.80969L9.16669 13.3097L5.66668 9.80969" stroke="#FBF3F1" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
          </div>
        </div>
      </template>
      ...
      <div class="popup-container" @click.stop>
        ...
        <div class="popup-details">
          ...
          <div class="invite-button-container">
            <button @click="closePopup()" class="cancel-button">{{ $t("buttonText.cancel") }}</button>
            <button
              @click="onClickCreateFolder(newProjectName)"
              :disabled="!newFolderName"
              class="update-address white"
            >{{ $t("buttonText.addFolder") }}</button>
          </div>
        </div>
      </div>
    </div>
    ...
    <!-- ---------------------------Welcome New User Popup--------------------------------- -->
     <div
      class="popup-div stop-scale"
      :class="(user && user.onboardingGoalFilled === false) ?'showPopUp':''"
      style="z-index:1"
      @click="closePopup"
    >
      <div class="popup-container welcome-popup" @click.stop>
        ...
        <div class="popup-head">
          ...
          >
            <path
              d="M13.3367 36.7067C13.5097 35.5824 14.0286 34.5445 14.8935 33.7661C15.4989 33.1607 16.1043 32.8148 16.8827 32.4688L15.5854 31.1716C13.4232 29.0094 13.4232 25.4634 15.5854 23.3013C16.1908 22.6959 16.8827 22.2634 17.7475 22.004C16.9691 20.7067 16.7962 19.1499 17.2286 17.6797V17.5932V17.5067C17.4016 17.1607 17.834 15.9499 18.9583 14.9986C19.9097 14.2202 21.1205 13.7878 22.4178 13.7878C23.4556 13.7878 24.407 14.0472 25.2718 14.5661C25.5313 13.7878 25.9637 13.0094 26.5691 12.404C27.607 11.3661 28.9908 10.7607 30.461 10.7607C31.9313 10.7607 33.3151 11.3661 34.3529 12.404L45.7691 23.5607C45.7691 23.4743 45.6827 23.3878 45.6827 23.3013C44.8178 21.2256 45.2502 18.8905 46.8935 17.2472C47.4124 16.7283 48.0178 16.2959 48.7097 16.0364C49.4016 15.777 50.0935 15.604 50.8718 15.604C51.5637 15.604 52.3421 15.777 52.9475 16.0364C54.3313 16.6418 55.3691 17.6797 55.9745 19.0634L64.0178 38.4364V38.5229V38.6094C66.4394 45.7013 64.7097 53.3121 59.434 58.5878C55.8016 62.2202 50.8718 64.2959 45.6827 64.2959C40.4935 64.2959 35.6502 62.3067 31.9313 58.5878L30.7205 57.377L14.807 41.4634C13.6827 40.2526 13.0772 38.4364 13.3367 36.7067ZM17.2286 39.2148L33.0556 55.1283L34.2664 56.3391C37.38 59.4526 41.5313 61.0959 45.6827 61.0959C49.834 61.0959 53.9854 59.5391 57.0989 56.3391C61.5097 51.9283 62.98 45.5283 60.9908 39.6472L52.9475 20.2743C52.6881 19.6689 52.2556 19.2364 51.7367 19.0634C51.4773 18.977 51.1313 18.8905 50.8718 18.8905C50.6124 18.8905 50.2664 18.977 50.007 19.0634C49.7475 19.1499 49.4881 19.3229 49.2286 19.5824C48.5367 20.2743 48.3637 21.2256 48.7097 22.0905C48.7097 22.0905 52.861 32.3824 53.2935 33.4202C53.5529 34.1121 53.2935 34.7175 52.7745 34.7175C52.5151 34.7175 52.2556 34.5445 51.9097 34.1986C50.8718 33.1607 47.1529 29.4418 47.1529 29.4418L44.2124 26.5013L32.1908 14.4797C31.7583 14.0472 31.1529 13.7878 30.5475 13.7878C29.9421 13.7878 29.3367 14.0472 28.9043 14.4797C28.0394 15.3445 28.0394 16.8148 28.9043 17.7661L43.0016 31.8634L43.5205 32.3824C44.1259 32.9878 44.1259 34.0256 43.5205 34.631C43.1745 34.977 42.8286 35.0634 42.3962 35.0634C42.1367 35.0634 41.7908 34.977 41.5313 34.804C41.4448 34.7175 41.3583 34.631 41.2718 34.5445L24.061 17.5067C23.6286 17.0743 23.0232 16.8148 22.4178 16.8148C21.8989 16.8148 21.38 16.9878 20.9475 17.3337C20.5151 17.6797 20.3421 18.1121 20.1691 18.458C19.9097 19.2364 20.1691 20.1013 20.7745 20.7067L37.9854 37.9175C38.3313 38.2634 38.5043 38.7824 38.4178 39.2148C38.4178 39.5607 38.2448 39.9067 37.9854 40.1661C37.6394 40.5121 37.2935 40.5986 36.861 40.5986C36.7745 40.5986 36.7745 40.5986 36.6881 40.5986C36.3421 40.5986 35.9962 40.4256 35.6502 40.1661L21.1205 25.6364C20.6881 25.204 20.0827 24.9445 19.4772 24.9445C18.8718 24.9445 18.2664 25.204 17.834 25.6364C16.9691 26.5013 16.9691 27.9716 17.834 28.9229L31.6718 42.6743L32.1908 43.1932L34.4394 45.4418C35.0448 46.0472 35.0448 47.0851 34.4394 47.6905C34.0935 48.0364 33.7475 48.1229 33.3151 48.1229C32.8827 48.1229 32.4502 47.9499 32.1908 47.6905L21.1205 36.6202L20.4286 35.9283C19.9962 35.4959 19.3908 35.2364 18.7854 35.2364C18.18 35.2364 17.5745 35.4959 17.1421 35.9283C16.7962 36.2743 16.6232 36.7067 16.5367 37.1391C16.4502 37.9175 16.6232 38.6959 17.2286 39.2148Z"
              fill="#4D4C4D"
            />
            <path
              d="M1.3151 30.6526C1.83401 30.6526 2.17996 30.9986 2.17996 31.5175C2.17996 38.8688 5.03402 45.7878 10.2232 50.9769C10.5692 51.3229 10.5692 51.8418 10.2232 52.1878C10.0502 52.3607 9.79078 52.4472 9.6178 52.4472C9.44483 52.4472 9.18537 52.3607 9.01239 52.1878C3.47726 46.6526 0.450232 39.3013 0.450232 31.5175C0.450232 30.9986 0.882664 30.6526 1.3151 30.6526Z"
              fill="#4D4C4D"
            />
            <path
              d="M6.24484 30.6526C6.76376 30.6526 7.10971 30.9986 7.10971 31.5175C7.10971 37.658 9.44484 43.4526 13.6827 47.8634C14.0286 48.2094 14.0286 48.7283 13.6827 49.0742C13.5097 49.2472 13.3367 49.3337 13.0773 49.3337C12.8178 49.3337 12.6448 49.2472 12.4719 49.0742C7.88808 44.3175 5.37998 38.0905 5.37998 31.5175C5.37998 30.9986 5.81241 30.6526 6.24484 30.6526Z"
              fill="#4D4C4D"
            />
            <path
              d="M49.661 10.3283C49.4016 10.3283 49.2286 10.2418 49.0556 10.0689C43.8664 4.87968 36.9475 2.02563 29.5962 2.02563C29.0772 2.02563 28.7313 1.67968 28.7313 1.16076C28.7313 0.641844 29.1637 0.295898 29.5962 0.295898C37.3799 0.295898 44.7313 3.32292 50.2664 8.85806C50.6124 9.20401 50.6124 9.72293 50.2664 10.0689C50.0934 10.2418 49.834 10.3283 49.661 10.3283Z"
              fill="#4D4C4D"
            />
            <path
              d="M29.5961 4.96615C36.0826 5.13913 42.2232 7.82021 46.8069 12.404C47.1529 12.7499 47.1529 13.2689 46.8069 13.6148C46.634 13.7878 46.3745 13.8743 46.2015 13.8743C46.0286 13.8743 45.7691 13.7878 45.5961 13.6148C41.3583 9.37696 35.6502 6.86886 29.5961 6.69588C29.0772 6.69588 28.7313 6.26345 28.7313 5.83102C28.6448 5.3121 29.0772 4.87967 29.5961 4.96615Z"
              fill="#4D4C4D"
            />
          </svg> -->
          <p class="wel-pop-title">{{ $t("welcomePopup.header") }}</p>
          <p class="wel-pop-sub-title">{{ $t("welcomePopup.subHeader") }}</p>
          <svg class="popup-background" width="1106" height="646" viewBox="0 0 1106 646" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="wel-cards-container">
            <div class="wel-card-item">
              <svg width="221" height="137" viewBox="0 0 221 137" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <!-- First Card----------- -->
            <!-- <div class="wel-card">
              <div class="wel-card-img">
                <img style="margin-top:1rem" src="~assets/images/rtime.png" alt />

                <p>See how you can reduce your design time by 60%</p>
              </div>
              <div class="wel-card-desc">
                <P>Create a Room</P>
                <P>Add furniture and textures</P>
                <P>Experience the magic of ultrafast rendering</P>
                <button @click="onClickWelcome('reduce_designtime')">Start Now</button>
                <img class="bg-pattern" src="~assets/images/bg-pattern.png" alt />
              </div>
            </div> -->
            <!-- Second Card ---------------- -->
            <!-- <div class="wel-card">
              <div class="wel-card-img">
                <img src="~assets/images/fr.png" style="width: 13rem;margin-top: 1.7rem;" alt />
                <p>Experience ultra fast rendering on an existing design</p>
              </div>
              <div class="wel-card-desc">
                <P>Use our Pre-designed Inspirations</P>
                <P>Customize by adding products & textures</P>
                <P>Experience the magic of ultrafast rendering</P>
                <button @click="onClickWelcome('fast_render')">Start Now</button>
                <img class="bg-pattern-second" src="~assets/images/bg-pattern-1.png" alt />
              </div>
            </div> -->
          </div>
    ...
    <DefaultPopup
			...
			:width="37.5 * 1.22 + 'rem'"
			height="21.5rem"
			class="ap-crm-form-popup"
			@closePopup="apCRMFormState = false"
		>
			<div class="heading-section-wrapper">CRM Integration</div>
      <div
        v-for="formField in Object.keys(apCRMForm)"
        :key="formField"
        class="form-input-wrapper"
        :class="{
          'error': apCRMFormInputsWithError.includes(formField)
        }"
      >
        <input
          v-model="apCRMForm[formField]"
          class="creat-project-input"
          type="text"
          :placeholder="formField"
          @click="onAPFormFieldInputClick"
          @input="onAPFormFieldInput(formField)"
          @blur="onAPFormFieldBlur($event, formField)"
        />
      </div>
      <div v-if="apCRMFormInputsWithError.length" class="error-container">
        *Please enter a valid {{ apCRMFormInputsWithError.join(", ") }}
      </div>
...
.ap-crm-form-popup {
  .main-container {
    ...
    flex-direction: column;
    align-items: center;
    padding: 2.875rem * 1.22 6.875rem * 1.22;
    ...
    .popup-action-button-wrapper {
      .button-container {
        padding: .625rem * 1.22 2.75rem * 1.22;
