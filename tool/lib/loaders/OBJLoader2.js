...
(function (global, factory) {
	...
	OBJLoader2.prototype = Object.assign( Object.create( THREE.Loader.prototype ), {
		...
		loadFromContent: function ( content, onLoad, onProgress, onError, onMeshAlter ) {
			...
			if(onProgress) {
				this.setCallbackOnProgress( onProgress );
			}
			this.setCallbackOnMeshAlter( onMeshAlter );
			this.parser.callbacks.onLoad( scope.parse( content ), "OBJLoader2#load: Parsing completed" );
		 ...
		 * @param {function} [onMeshAlter] Called after every single mesh is made available by the parser
		 */
		load: function ( url, onLoad, onFileLoadProgress, onError, onMeshAlter, onProgress ) {
