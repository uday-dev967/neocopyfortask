      ...
      <div class="popup-container" @click.stop>
        ...
        <div class="popup-details">
          ...
          <div class="invite-button-container">
            ...
            <button @click="deleteProject" class="update-address white">Confirm</button>
          </div>
        </div>
      </div>
    </div>
...
export default {
	props: {},
	computed: {
		...mapGetters("moodboardDashboard", ["showDeleteConfirmation"]),
	},
	methods: {
		...mapMutations("moodboardDashboard", ["setshowDeleteConfirmation"]),
		...mapActions("moodboardDashboard", ["deleteMBProject"]),
		...mapActions("Moodboard", ["fetchProjects"]),
		closePopup() {
			this.setshowDeleteConfirmation(false);
		},
		deleteProject() {
			this.deleteMBProject().then(res => {
