<template>
	<div class="popup-div" :class="showMoodboardBasicPaywall ? 'showPopUp' : ''">
		<div class="popup-container moodboard-basic-paywall">
            ...
            <div class="popup-body">
                <header class="pop-over-header">
                    <h2 class="noselect">Uh-oh!</h2>
                </header>
                <div class="message-container">
                    <p>Please upgrade your plan to use this feature</p>
                </div>
                <footer class="pop-over-buttons second-style">
                    <button class="noselect" @click="handleDoItLAterClick">I'll do it later</button>
                    <button class="noselect" @click="handleUpgradeClick">Upgrade</button>
                </footer>
            </div>
		</div>
	</div>
...
export default {
  ...
  computed: {
    ...
    ...mapGetters("Dash", ["showMoodboardBasicPaywall"]),
  },
  methods: {
    ...mapActions({
    ...
    handleDoItLAterClick() {
        this.setShowMoodboardBasicPaywall(false)
    },
    handleUpgradeClick() {
        this.setShowMoodboardBasicPaywall(false)
        this.$router.push('/moodboard/settings/profile')
    }
  }
};
</script>
...
.moodboard-basic-paywall {
  background-color: $background-4;
  width: 49.75rem * 1.22;
  min-height: 21.5rem * 1.22;
  padding: 0;
  display: flex;

  .popup-body {
    padding: 3rem * 1.22 4.5rem * 1.22;
    width: 100%;
    ...
    .message-container {
      margin: 2.5rem * 1.22 5.625rem * 1.22;
